...
class PostgresLoader:
    ...
    def load(self, reader: Reader):
        # TODO: Misschien iets toevoegen aan de load methode dat wanneer hij probeert een value (met bepaald datatype)
        # toe wil voegen aan een kolom die al een ander datatype toegewezen heeft gekregen hij het datatype
        # van de kolom wijzigt naar het meest 'tolerante' datatype namelijk TEXT.
